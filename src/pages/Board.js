                ...
                <Grid container style={{marginTop: '3%', textAlign: 'center'}}>
                    ...
                    <Grid item
                        ...
                        <TextField name='moddate'
                                ...
                                size='small'
                                aria-readonly='true'
                                value={board != null ? board.moddate.substring(0, board.regdate.indexOf('T')) : ''}></TextField>
                    </Grid>
                </Grid>
                <Grid container style={{marginTop: '3%', textAlign: 'center'}}>
                    <Grid item
                    ...
                    <Grid item
                        ...
                        <TextField name='cnt'
                                ...
                                size='small'
                                aria-readonly='true'
                                value={board != null ? board.cnt : ''}></TextField>
                    </Grid>
                </Grid>
                <Grid container style={{marginTop: '3%', textAlign: 'center'}}>
                    <Grid item
                                ...
                                >
                                    ...
                                    <img width='150px'
                                         ...
                                         src={boardFile.filetype === 'image'
                                            ? `https://kr.object.ncloudstorage.com/bitcamp-134/${boardFile.filepath}${boardFile.filename}`
